...
| **[EPIC-007](EPIC-007_runtime_state_console/README.md)** | Runtime State Console — attach to a running app and see what is wired, registered and alive; every milestone ends in a command you can run, demoed through `examples/student_management` | ✅ 6/6 subtasks done |
| **[EPIC-008](EPIC-008_runtime_state_console_ui_redesign/README.md)** | Runtime State Console — UI Redesign — new visual language and shared shell (connection band, rail badges, sortable tables, connect flow) for the console `EPIC-007` shipped | 🟡 In Progress (4/6 subtasks done) |
