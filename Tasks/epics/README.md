...
| **[EPIC-008](EPIC-008_runtime_state_console_ui_redesign/README.md)** | Runtime State Console — UI Redesign — new visual language and shared shell (connection band, rail badges, sortable tables, connect flow) for the console `EPIC-007` shipped | 🟡 In Progress (2/6 subtasks done) |
