...
| **[EPIC-002](EPIC-002_engine_sample_app_and_doc_rewrite/README.md)** ([onboarding](EPIC-002_engine_sample_app_and_doc_rewrite/ONBOARDING.md)) | Engine Sample App & Doc Rewrite — replace the stale `.agents/context/` snapshot with docs grounded in a real, running sample app | 🟡 In Progress (1/4 subtasks done) |
