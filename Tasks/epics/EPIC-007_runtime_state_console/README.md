...
- **Status**: 🟠 **Proposed** — specification complete, no code written
- **Created**: 2026-08-27
- **Priority**: P2
...
| :--- | :--- | :--- | :--- |
| **[A](incomplete/EPIC-007A_snapshot_contract_protocol_v2.md)** | Snapshot dataclasses in `contracts.py`; `PROTOCOL_VERSION` 1 → 2 | `pytest -k snapshot` | Round-trip is lossless; a v1 client is refused at connect with both versions named |
