...
#: module, not a reusable component. The check converts a future accidental
#: split of the pair into a loud failure here rather than a silent
#: `QQuickWidget.setSource()` failure at first use.
#:
...
if not _OVERLAY_HOST_QML.is_file():
    raise RuntimeError(
