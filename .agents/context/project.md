...
| Tools / Apps | Business Logic, Domain, UI. Reference: `examples/student_management` (Clean Architecture + `pyside_mvc` QML UI, see `examples.md`). The QtWidgets kit and its gallery left this repo in `EPIC-007H` — they live in the consuming app now. |
